...
import {
  ...
  ArrowRight, Phone, Leaf, BadgeCheck, Quote, Star, Sparkle,
} from 'lucide-react';
...
const About = () => (
  <div className="min-h-screen bg-midnight font-sans">
    ...
    {/* ── HERO ── */}
    <section className="relative overflow-hidden" style={{ background: 'linear-gradient(120deg, #0B1220 55%, #2c1810)', padding: '80px 0 90px' }}>
      ...
      <div className="max-w-7xl mx-auto px-6 relative text-center">
        ...
        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black text-white leading-tight mb-4">
          About <span className="text-primary">Naina Cleaning</span> Services
        </h1>
    ...
    <section className="bg-surface/50">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 -mt-14 relative z-10 mb-16">
          {STATS.map((s, i) => (
            <div key={s.label} className="glass-card p-6 text-center">
              <div className="text-4xl font-black text-primary leading-none mb-1.5"><AnimCounter target={s.value} /></div>
              <div className="text-surface-muted text-sm font-semibold">{s.label}</div>
            </div>
          ))}
        </div>
      </div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <h2 className="text-3xl sm:text-4xl font-black text-white leading-tight mb-4">
              25 Years of Trusted <span className="text-primary">Cleaning Excellence</span>
            </h2>
            <p className="text-surface-muted text-base leading-relaxed mb-4">
          ...
          <div className="flex flex-col gap-5">
            {/* Mission card */}
            <div className="rounded-2xl p-8 bg-gradient-to-br from-primary to-primary-700 text-white">
            ...
            <div className="glass-card p-8">
              ...
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-primary flex items-center justify-center text-white font-extrabold text-base">M</div>
                <div>
                  <div className="text-white font-bold text-sm">Michael R.</div>
                  <div className="text-surface-muted text-xs">Business Owner, Mississauga</div>
                </div>
              </div>
            </div>
          </div>
    ...
    <section className="py-20 bg-midnight">
      <div className="max-w-7xl mx-auto px-6 text-center">
        <div className="inline-flex items-center gap-1.5 px-4 py-2 rounded-full bg-primary/20 border border-primary/30 text-primary text-[11px] font-bold tracking-wider uppercase mb-4">
          <BadgeCheck size={12} /> OUR VALUES
        </div>
        <h2 className="text-3xl sm:text-4xl font-black text-white leading-tight mb-4">
          The Principles That <span className="text-primary">Guide Us</span>
        </h2>
        <p className="text-surface-muted text-base max-w-lg mx-auto mb-14 leading-relaxed">
          Everything we do is guided by four core values that have defined us for 25 years.
        </p>
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {VALUES.map(v => (
            <div key={v.title} className="glass-card p-8 text-left hover:border-primary/30 transition-all duration-300 hover:-translate-y-1">
              ...
              <p className="text-surface-muted text-sm leading-relaxed">{v.desc}</p>
            </div>
          ))}
        </div>
      </div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="grid grid-cols-2 gap-4">
            {[
              ...
              <div key={item.t} className="glass-light p-5 rounded-xl">
                <div className="w-10 h-10 rounded-lg bg-primary/20 flex items-center justify-center mb-3">
                  <item.icon size={20} className="text-primary" />
                </div>
                <div className="font-bold text-white text-sm mb-1">{item.t}</div>
                <div className="text-surface-muted text-xs">{item.s}</div>
              </div>
            ))}
          </div>
        </div>
    ...
    {/* ── FINAL CTA ── */}
    <section className="py-20 relative overflow-hidden" style={{ background: 'linear-gradient(120deg, #0B1220 55%, #2c1810)' }}>
      <div className="absolute top-0 right-[5%] w-[500px] h-[500px] rounded-full bg-primary/10 blur-[80px]" />
      <div className="max-w-7xl mx-auto px-6 relative text-center">
        <h2 className="text-3xl sm:text-4xl font-black text-white leading-tight mb-4">
          Ready to Work With Us?
        </h2>
        <p className="text-surface-muted text-lg max-w-lg mx-auto mb-10 leading-relaxed">
